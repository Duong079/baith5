 ...
 */
// Generated on: 21.05.2025 16:15:14
...
const TfArray<1, float> quant0_scale = { 1, { 0.31372550129890442, } };
const TfArray<1, int> quant0_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data1[4] = { -18, 27, -10, 25, };
const TfArray<1, int> tensor_dimension1 = { 1, { 4 } };
const TfArray<1, float> quant1_scale = { 1, { 0.00096641870914027095, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[4*10] = { 
  71, 71, 123, -48, 10, -101, -127, -27, 120, 55, 
  68, -22, -96, -111, -94, -97, 17, 37, -40, 19, 
  -100, 106, -79, -108, 88, -99, 113, 62, 66, -75, 
  15, -23, 0, 59, 36, -55, 94, -30, -98, -113, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 4,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.0052076941356062889, } };
const TfArray<1, int> quant2_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&quant2_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { -11, 0, 0, 13, 0, 0, 17, 1, -36, -17, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00072569749318063259, } };
const TfArray<1, int> quant3_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant3 = { (TfLiteFloatArray*)&quant3_scale, (TfLiteIntArray*)&quant3_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  44, -84, -76, 12, 106, 15, 124, -114, -8, -57, 23, 18, 69, 124, 59, -92, 0, -31, -77, 25, 
  ...
  64, 15, 104, 7, -69, 87, -63, -50, -28, 84, 112, 56, -80, -102, -5, -46, -29, -56, 115, 95, 
  ...
  100, 51, -61, -81, 91, 89, 12, -36, -25, 7, 72, 48, -78, -45, 10, -15, 65, -16, -18, -34, 
  -16, 99, 52, 67, -12, 94, 95, -121, 124, -33, -64, 123, 72, -29, -109, 55, 94, 6, 15, 92, 
  68, 44, 53, 37, 88, 29, -119, -28, -40, 6, 96, 16, -5, -114, -37, 97, -95, 70, -52, -43, 
  48, -78, -21, -6, 83, 106, -22, 12, 80, -106, -69, 49, -81, -59, 61, -24, -20, 93, 3, 80, 
};
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { 0, 0, -15, -16, -23, -7, 0, 0, -7, 13, -9, -2, 0, 0, 0, -18, 0, -18, 0, 1, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 0.0012298945803195238, } };
...
const TfArray<1, float> quant6_scale = { 1, { 0.0039202887564897537, } };
const TfArray<1, int> quant6_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant6 = { (TfLiteFloatArray*)&quant6_scale, (TfLiteIntArray*)&quant6_zero, 0 };
const TfArray<2, int> tensor_dimension7 = { 2, { 1,20 } };
const TfArray<1, float> quant7_scale = { 1, { 0.20644904673099518, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1,10 } };
const TfArray<1, float> quant8_scale = { 1, { 0.18557517230510712, } };
const TfArray<1, int> quant8_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant8 = { (TfLiteFloatArray*)&quant8_scale, (TfLiteIntArray*)&quant8_zero, 0 };
const TfArray<2, int> tensor_dimension9 = { 2, { 1,4 } };
const TfArray<1, float> quant9_scale = { 1, { 0.20874136686325073, } };
